...
#         epochs = 40
#         fw_tuning_epochs = 10 # None if not specified
...
#         apply_dora_to_ViT(model, n_vision_layers=vision_layers, n_transformer_layers=0, r=rank, dora_dropout=0.1, seed=random_seed)
#         apply_dora_to_ViT(model, n_vision_layers=0, n_transformer_layers=transormer_layers, r=32, dora_dropout=0.1, seed=random_seed)
#         switch_dora_layers(model, freeze_all=True, d_state=dora_d_state, m_state=dora_m_state)
#         unfreeze_weighting_parameters(model)
...
#         # print(model)
#         train_model(model, train_loader, test_loader, device, criterion, p_weight, m_weight, g_weight, optimizer_0, optimizer_1, epochs, fw_tuning_epochs, rdms, sample_timepoints, ms_start, ms_end, ms_step, train_window_size, early_stopping_patience_0, early_stopping_patience_1, checkpoint_path)